...
export default function Footer() {
  ...
  const footerLinks = {
    collections: [
      { name: "Swiss Precision", href: "/collections/swiss" },
      { name: "American Heritage", href: "/collections/american" },
      { name: "Military Timepieces", href: "/collections/military" },
      { name: "Dress Watches", href: "/collections/dress" },
    ],
    services: [
      { name: "Authentication", href: "/services/authentication" },
      { name: "Restoration", href: "/services/restoration" },
      { name: "Acquisition", href: "/services/acquisition" },
      { name: "Valuation", href: "/services/valuation" },
    ],
    company: [
      { name: "About Us", href: "/about" },
      { name: "Our Experts", href: "/about/experts" },
      { name: "Certifications", href: "/about/certifications" },
      { name: "Contact", href: "/contact" },
    ],
    resources: [
      { name: "Buying Guide", href: "/resources/buying-guide" },
      { name: "Care Instructions", href: "/resources/care" },
      { name: "Market Reports", href: "/resources/market" },
      { name: "Blog", href: "/blog" },
    ],
  };
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-background/80 leading-relaxed max-w-md">
                Curating the world&apos;s finest vintage timepieces with unmatched expertise 
                in authentication, restoration, and acquisition services.
              </p>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="text-background/80 text-sm">
              &copy; {currentYear} Horologium. All rights reserved. Published by Codestam Technologies.
            </div>
