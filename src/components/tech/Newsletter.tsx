...
import { Mail, Brain, Shield, Rocket } from "lucide-react";
            ...
            <CardContent className="p-8 md:p-12">
              <div className="text-center space-y-8">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="mx-auto w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center tech-glow"
                >
                ...
                >
                  ...
                  <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                    ...
                    and emerging technologies. Join our community of innovators and thought leaders.
                  </p>
                </motion.div>
                ...
                >
                  <div className="flex items-center space-x-4 p-4 bg-secondary/30 rounded-xl group hover:bg-primary/10 transition-all duration-300">
                    <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center group-hover:tech-glow transition-all duration-300">
                      <Brain className="w-6 h-6 text-primary" />
                    </div>
                    <div>
                      <div className="font-semibold text-foreground">AI Insights</div>
                      <div className="text-sm text-muted-foreground">Latest AI breakthroughs</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-secondary/30 rounded-xl group hover:bg-primary/10 transition-all duration-300">
                    ...
                    <div>
                      <div className="font-semibold text-foreground">Security Updates</div>
                      <div className="text-sm text-muted-foreground">Cybersecurity trends</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-secondary/30 rounded-xl group hover:bg-primary/10 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Beta features & demos</div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                    ...
                    />
                    <Button className="tech-gradient hover:tech-glow text-primary-foreground border-0 font-semibold px-8">
                      Subscribe
                    </Button>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Join 50,000+ tech professionals. Unsubscribe at any time.
                  </p>
                </motion.div>
